...
function start() {
	...
	(0, _commonJsCommonJs.init_set)(_commonJsCommonJs.size);
	...
	tl.from(".line_2", 1.6, { clip: "rect(0px, " + 0 + "px, " + _commonJsCommonJs.size.hh + "px, 0px)" });
...
function grow() {
	...
	tl_bang.add("bang", 1);
	tl_bang.from(".line_1", 1.6, { clip: "rect(0px, " + 0 + "px, " + _commonJsCommonJs.size.hh + "px, 0px)" }, "bang");
